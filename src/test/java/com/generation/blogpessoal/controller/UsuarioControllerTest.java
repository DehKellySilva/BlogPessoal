...
public class UsuarioControllerTest {
	...
	public void deveMostrarTodosUsuarios() {
		...
		// Será uma String, por ser uma lista
		// null, porque o get não devolve nada
	...
	/*@Test
	@Order(5)
	@DisplayName("Verificar um ID")
	public void verificarId() {

		Optional<Usuario> verificarUsuario = usuarioRepository.findById(0L);

		usuarioService.cadastrarUsuario(new Usuario(0L, "Sabrina Sanches", "sabrina_sanches@email.com.br", "sabrina123",
				"https://i.imgur.com/5M2p5Wb.jpg"));

		assertFalse(verificarUsuario.isPresent());
	}*/
	...
	public void deveListarApenasUmUsuario() {
		...
		Optional<Usuario> usuarioBusca = usuarioService.cadastrarUsuario(new Usuario(0L, "Denise",
				"denise@email.com", "denise1234", "https://i.imgur.com/yDRVeK7.jpg"));
	...
	public void deveAutenticarUsuario() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L, "Denise",
				"denise@email.com", "denise1234", "https://i.imgur.com/yDRVeK7.jpg"));
		
		HttpEntity<UsuarioLogin> corpoRequisicao = new HttpEntity<UsuarioLogin>(new UsuarioLogin(0L, "",
				"denise@email.com", "denise1234", ""));

		ResponseEntity<UsuarioLogin> corpoResposta = testRestTemplate.exchange("/usuarios/logar",
				HttpMethod.POST, corpoRequisicao, UsuarioLogin.class);
